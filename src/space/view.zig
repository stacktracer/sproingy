...
pub fn SpaceView( comptime N: usize, comptime P: usize ) type {
    return struct {
        const Self = @This();
        ...
        dotsPaintable: DotsPaintable(N,P),
        ...
        pub fn init( self: *Self, xLimits: *const [2]Interval, tCursor: *const VerticalCursor, allocator: *Allocator ) !void {
            ...
            self.dotsPaintable = DotsPaintable(N,P).init( "SpaceView.dotsPaintable", _axes, tCursor, allocator );
