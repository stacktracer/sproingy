...
pub fn main( ) !void {
    ...
    const scaleFactor = gtkzScaleFactor( glArea );
    var axis0 = Axis.init( -8.4, 8.4, 480*scaleFactor );
    var axis1 = Axis.init( -6.4, 6.4, 360*scaleFactor );
    ...
    var axisUpdatingHandler = AxisUpdatingHandler(2).init( axes, [_]u1 { 0, 1 }, true );
